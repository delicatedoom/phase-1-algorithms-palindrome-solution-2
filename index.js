...
/*
  I need to make an isPalindrome function that returns true or false. When
  ...
  is the same as the second to last letter, etc. the function should return true. For the word "racecar", the first and
